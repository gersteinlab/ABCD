...
def processing_genomics():
    genomics_phenotypes_path_1 = '/gpfs/gibbs/pi/gerstein/jjl86/data/ABCD/bb926/PRSs/adhd2019/mj.pipeline/ldpred2/RData/ldpred2_prs_auto.out.tsv'
